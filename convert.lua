...
local usage = [[
Natao mba hanamora ny famadihana ireo fichier conky.config v1.x ho amin'ny syntax vaovao.
Tsaratsara kokoa raha hampiaharana amin'ny dos2unix. 
Marihana fa mety tsy ho hitan'ny conky manager intsony ilay fichier config. Mampiasa conky -c <toerana_misy_ilay_fichier>/<anarana_fichier>
Nalaina tao amin'ny <https://github.com/brndnmtthws/conky/wiki>
]];
